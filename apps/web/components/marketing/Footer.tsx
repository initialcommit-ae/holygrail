      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl tracking-tight text-slate-900">MeshAi</span>
            <span className="text-slate-400 text-sm ml-8">© 2024 MeshAi Inc.</span>
          </div>

          <div className="flex gap-12 text-[13px] text-slate-500">
